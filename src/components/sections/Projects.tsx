  ...
  <div className="flex flex-col md:flex-row items-center gap-6">
    ...
    <div>
      <div className="flex items-center mb-3">
        <div className="mr-3 px-3 py-1 bg-accent-100 dark:bg-accent-900/30 text-accent-700 dark:text-accent-400 text-xs font-medium rounded-full">
      ...
      <div>
        ...
        <p className="text-sm text-dark-500 dark:text-light-500">Implementazione in corso</p>
      </div>
    </div>
  </div>
</motion.div>
